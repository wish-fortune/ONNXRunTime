...
if (CMAKE_SYSTEM_NAME STREQUAL "Emscripten")
  ...
  if (onnxruntime_ENABLE_WEBASSEMBLY_THREADS)
    set_property(TARGET onnxruntime_test_all APPEND_STRING PROPERTY LINK_FLAGS " -s DEFAULT_PTHREAD_STACK_SIZE=131072 -s PROXY_TO_PTHREAD=1 -s -s PTHREAD_POOL_SIZE=\"Math.min(32, (typeof navigator !== 'undefined') ? navigator.hardwareConcurrency : require('node:os').cpus().length)\"")
  endif()
  if (onnxruntime_USE_JSEP)
